						...
						if($courseCount>0){
							for ($k=0; $k<$courseCount; $k++){
								...
								if($usingCanvas == "true"){
									...
									echo '<li class="'.$courseID.' '.$syllabusClass.' usingCanvas">
										...
										<a href="'.$GLOBALS['canvasURL'].'/courses/'.$courseID.'" class="canvasLink" target="_blank" data-toggle="tooltip" title="Open course in Canvas"><i class="icon-share-alt"></i></a>
										'.$instructors.$instructorSpanList.$syllabusTool.'
										</li>';
								} else {
									echo '<li class="'.$courseID.' notUsingCanvas"><i class="icon-remove-sign"></i> '.$courseName.' <a href="'.$GLOBALS['canvasURL'].'/courses/'.$courseID.'" class="canvasLink" target="_blank" title="Open course in Canvas"><i class="icon-share-alt"></i></a>
